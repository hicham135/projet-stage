...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Mon Historique de Présence - Administration RH</h1>
    ...
    <div class="card mb-4">
        <div class="card-header bg-light">
            <form action="{{ route('hr.attendance.history') }}" method="GET" class="row g-3 align-items-center">
                <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-3">
                        <a href="{{ route('hr.dashboard') }}" class="btn btn-warning">
                            <i class="fas fa-tachometer-alt me-2"></i>Tableau de bord RH
                        </a>
                        <a href="{{ route('hr.users.index') }}" class="btn btn-primary">
